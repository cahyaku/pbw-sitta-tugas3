/**
 * Stok Component - Vue.js Component untuk Manajemen Stok Bahan Ajar
 * Menggunakan Vue Component pattern dan fetch data dari JSON
 */

// Define Stok Component
window.StokComponent = {
    data() {
        return {
        ...
        async loadDataFromJSON() {
            try {
                ...
                if (data) {
                    ...
                    console.log('  - UPBJJ List:', this.upbjjList.length, 'items');
                    console.log('  - Kategori List:', this.kategoriList.length, 'items');
                    console.log('  - Stok:', this.stok.length, 'items');
                }
                ...
                this.showAlert('danger', 'Error', 'Gagal memuat data dari server');
            }
        },
        ...
        saveStock() {
            try {
                ...
                if (this.editMode) {
                    ...
                    // Tambah stok baru
                    this.stok.push({ ...this.formData });                        // Tutup modal terlebih dahulu
                    this.closeModal();
    ...
    async mounted() {
        console.log('🎯 Stok Component Mounted');
        ...
        console.log('✓ Stok Component Ready');
    }
};
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initialize Vue App dengan Stok Component
    console.log('🚀 Initializing Stok Vue App...');
    initVueApp('#app', 'StokComponent');
});